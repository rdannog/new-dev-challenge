...
class Vehicle extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component){constructor(...args){super(...args);this.state={vehicleList:[]};}async componentDidMount(){const response=await _services_api__WEBPACK_IMPORTED_MODULE_1__/* .data.get */ .a.get("/vehicles");this.setState({vehicleList:response.data.results});console.log(response);}render(){const{vehicleList}=this.state;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment),null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Header_header__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_styles__WEBPACK_IMPORTED_MODULE_3__/* .Title */ .Dx,null,"Vehicle"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_styles__WEBPACK_IMPORTED_MODULE_3__/* .Container */ .W2,null,vehicleList.map((vehicle,i)=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_styles__WEBPACK_IMPORTED_MODULE_3__/* .Card */ .Zb,{key:i},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",null,vehicle.name),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",null,vehicle.manufacturer),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",null,vehicle.model)))));}}
...
;
//# sourceMappingURL=component---src-pages-vehicle-js.js.map