...
class Starships extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  constructor(...args) {
    ...
    this.state = {
      starshipsList: [],
      random: "Get a random Star Wars spaceships info!"
    };
    ...
    this.handleClick = () => {
      ...
      const allStarships = starshipsList.map((starship, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_styles__WEBPACK_IMPORTED_MODULE_3__.Card, {
        key: i
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, starship.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, starship.manufacturer), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, starship.model)));
      this.setState({
