...
class Starships extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component){constructor(...args){super(...args);this.state={starshipsList:[]};}async componentDidMount(){const response=await _services_api__WEBPACK_IMPORTED_MODULE_1__/* .data.get */ .a.get("/starships");this.setState({starshipsList:response.data.results});console.log(response);}render(){const{starshipsList}=this.state;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment),null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Header_header__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_styles__WEBPACK_IMPORTED_MODULE_3__/* .Title */ .Dx,null,"Starships"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_styles__WEBPACK_IMPORTED_MODULE_3__/* .Container */ .W2,null,starshipsList.map((starship,i)=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_styles__WEBPACK_IMPORTED_MODULE_3__/* .Card */ .Zb,{key:i},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",null,starship.name),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3",null,starship.manufacturer),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",null,starship.model)))));}}
