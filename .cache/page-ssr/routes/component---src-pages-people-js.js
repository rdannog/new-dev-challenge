...
class People extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component){constructor(...args){super(...args);this.state={peopleList:[]};}async componentDidMount(){const response=await _services_api__WEBPACK_IMPORTED_MODULE_1__/* .data.get */ .a.get("/people");this.setState({peopleList:response.data.results});console.log(response);}render(){const{peopleList}=this.state;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment),null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Header_header__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_styles__WEBPACK_IMPORTED_MODULE_3__/* .Title */ .Dx,null,"People"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_styles__WEBPACK_IMPORTED_MODULE_3__/* .Container */ .W2,null,peopleList.map((people,i)=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_styles__WEBPACK_IMPORTED_MODULE_3__/* .Card */ .Zb,{key:i},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",null,people.name),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3",null,people.birth_year),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",null,people.hair_color)))));}}
