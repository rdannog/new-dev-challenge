...
const Films = () => {
  ...
  const {
    0: randomData,
    1: setRandomData
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Get random Star Wars film opening!"));
  const {
    0: error,
    1: setError
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    _services_api__WEBPACK_IMPORTED_MODULE_1__.data.get("/films").then(response => {
