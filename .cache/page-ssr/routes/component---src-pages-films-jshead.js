exports.id = "component---src-pages-films-jshead";
exports.ids = ["component---src-pages-films-jshead"];
exports.modules = {
...
/***/ "./src/pages/films.js?export=head":
/*!****************************************!*\
  !*** ./src/pages/films.js?export=head ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class Films extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  constructor(...args) {
    super(...args);
    this.state = {
      films: []
  ...
  async componentDidMount() {
    const response = await _services_api__WEBPACK_IMPORTED_MODULE_1__.data.get("/films");
    this.setState({
  ...
  render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Header_header__WEBPACK_IMPORTED_MODULE_2__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Films"), films.map((film, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      key: i
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, film.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, film.release_date), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, film.opening_crawl)))));
  }
...
;
//# sourceMappingURL=component---src-pages-films-jshead.js.map