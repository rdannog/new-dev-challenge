...
const Planets = () => {
  ...
  const {
    0: randomPlanet,
    1: setRandomPlanet
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Get random Star Wars planets info!"));
  const {
    0: error,
    1: setError
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    _services_api__WEBPACK_IMPORTED_MODULE_1__.data.get("/planets").then(response => {
